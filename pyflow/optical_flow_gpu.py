...
tool_path = '../bin/calOpticalFlowFromImg'
video_tool_path = '../bin/calOpticalFlowFromVideo'
step = 2
...
def tvl_flow(img_paths, flow_paths):
    ...
    for index, (img_path, flow_path) in enumerate(zip(img_paths, flow_paths)):
        ...
        cmd = tool_path + ' -i={} -f={} -s={} -d={} -t={}'.format(quote(img_path), quote(flow_path), int(step), int(dev_id), int(method_type))
...
def tvl_flow_video(video_paths, flow_paths):
    ...
    for index, (video_path, flow_path) in tqdm(enumerate(zip(video_paths, flow_paths))):
        ...
        print(index, '/', l, '/', dev_id)
        cmd = video_tool_path + ' -i={} -f={} -s={} -d={} -t={}'.format(quote(video_path), quote(flow_path), int(step), int(dev_id), int(method_type))
        os.system(cmd)


def ucf():
    root = '/home/xxx/Database/UCF101/img/'
    target = '/home/xxx/Database/UCF101Flow/UCF101FlowTVL'
...
def ucf_video():
    root = '/home/xxx/Database/UCF101/img/'
    target = '/home/xxx/Database/UCF101Flow/UCF101FlowBrox'
    video_root = '/home/xxx/Database/UCF101/video'
...
def jester():
    root = '/home/xxx/Database/20bn-jester-v1/'
    target = '/home/xxx/Database/JesterFlow/TVL'
